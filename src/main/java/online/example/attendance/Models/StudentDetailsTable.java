...
public class StudentDetailsTable {
    ...
    public StudentDetailsTable(int student_id, int class_id, int contact_number, String student_address,
            String student_dob, String student_father_name, String student_full_name, String student_gender,
            String student_mother_name, int student_roll_no, int school_id) {
